...
\usepackage[useregional]{datetime2} % all scientific papers should have a date
\usepackage{float} % allow me to compel figures to go where I want them to
\usepackage[bookmarks=false]{hyperref} % load hyperref last!
...
Warszawska 22A Str., 05-130 Zegrze, Poland. Email: i.kubiak@wil.waw.pl}
\thanks{\IEEEauthorrefmark{2}University of Denver, \T Ritchie School of
Engineering and Computer Science, 2155 East Wesley Avenue, Denver,
Colorado 80208, USA. Email: joe.loughry@cs.du.edu}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_01_smaller.jpg}
...
\begin{figure*}[!ht]
    \centering
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_03a_small.jpg}%
    \label{figure:Figure_03a}}
    \hfill
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_03b_small.jpg}%
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_04a_smaller.jpg}%
    \label{figure:Figure_04a}}
    \hfill
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_04b_smaller.jpg}%
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_05a_smaller.jpg}%
    \label{figure:Figure_05a}}
    \hfill
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_05b_smaller.jpg}%
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_06a_smaller.jpg}%
    \label{figure:Figure_06a}}
    \hfill
    \subfloat[]{\includegraphics[width=\columnwidth]{Figure_06b_smaller.jpg}%
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_07_small.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_08_small.jpg}
    \caption{Waveforms of control signals on pins 6 (lower trace) and 9
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_09_smaller.jpg}
    \caption{Waveforms of control signals on pins 6 (lower trace) and 9
...
\begin{figure}[H] % `H' means force the figure not to float.
    \centering
    \subfloat[Printer $A$]{\includegraphics[width=0.45\columnwidth]{Figure_02a_small.jpg}%
    \label{figure:Figure_02a}}
    \hfill
    \subfloat[Printer $B$]{\includegraphics[width=0.45\columnwidth]{Figure_02b_small.jpg}%
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_10_small.jpg}
    \caption{Waveforms of control signals on pins 6 (lower trace) and 9
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_11_smaller.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_12_smaller.jpg}
    \caption{Waveforms of useful signals (one of the differential pairs) of
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_13_smaller.jpg}
    \caption{Waveforms of useful signals (one of the differential pairs) of
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_14_smaller.jpg}
    \caption{Waveforms of useful signals (one of the differential pairs) of
...
\begin{figure*}[ht]
    ...
    \subfloat[]{
        ...
        \includegraphics[width=0.49\columnwidth]{Figure_15a_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=0.49\columnwidth]{Figure_15a_right.jpg}%
        \label{figure:Figure_15a}
        \hspace{\fill}
        \includegraphics[width=0.49\columnwidth]{Figure_15b_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=0.49\columnwidth]{Figure_15b_right.jpg}%
        \label{figure:Figure_15b}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=\columnwidth]{Figure_15c_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{Figure_15c_right.jpg}%
...
\begin{figure*}[!ht]
    \centering
    \subfloat[]{
        \includegraphics[width=\columnwidth]{Figure_16a_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{Figure_16a_right.jpg}%
        \label{figure:Figure_16a}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=\columnwidth]{Figure_16b_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{Figure_16b_right.jpg}%
        \label{figure:Figure_16b}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=\columnwidth]{Figure_16c_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{Figure_16c_right.jpg}%
        \label{figure:Figure_16c}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=\columnwidth]{Figure_16d_left.jpg}%
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{Figure_16d_right.jpg}%
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\textwidth]{Figure_17_much_smaller.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{Figure_18_smaller.jpg}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\textwidth]{Figure_19_much_smaller.jpg}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_20a.jpg}
        \label{figure:Figure_20a}
    }
    \hfil
    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_20b.jpg}
        \label{figure:Figure_20b}
    }

    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_20c.jpg}
        \label{figure:Figure_20c}
    }
    \hfil
    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_20d.jpg}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_21a.jpg}
        \label{figure:Figure_21a}
    }
    \hfil
    \subfloat[]{
        \includegraphics[width=2.38in]{Figure_21b.jpg}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=3in]{Figure_22_top.jpg}

    \bigskip

    \includegraphics[width=\textwidth]{Figure_22_low.jpg}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=3in]{Figure_23.jpg}
